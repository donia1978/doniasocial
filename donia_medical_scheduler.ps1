...
Write-Host "== DONIA: Medical Scheduler Core Migration =="

# Ensure migration folder
$ts = (Get-Date).ToString("yyyyMMddHHmmss")
$mig = "supabase\migrations\${ts}_donia_medical_scheduler.sql"
...
"@ | Set-Content -Encoding UTF8 $mig

Write-Host "Migration file created: $mig"
Write-Host "✅ Copy this SQL into Supabase Studio → SQL Editor → Run"
